...
const tools = [
  ...
  { name:"PhotoAI",         icon:"🖼️", cat:"image",        desc:"Generate stunning AI photos of yourself — realistic portraits and styles",                 badge:"paid", link:"https://photoai.com",                        rating:4.4 },
  { name:"AdCreative.ai",   icon:"📣", cat:"image",        desc:"Generate high-converting ad creatives and banners using AI — built for marketers",         badge:"paid", link:"https://www.adcreative.ai",                  rating:4.4 },
  ...
  { name:"Pictory AI",      icon:"🎬", cat:"video",        desc:"Turn blogs and scripts into videos automatically — great for content creators",            badge:"paid", link:"https://pictory.ai",                         rating:4.5 },
  { name:"Colossyan",       icon:"🤖", cat:"video",        desc:"Create AI avatar training videos in 70+ languages — perfect for businesses",               badge:"paid", link:"https://www.colossyan.com",                  rating:4.5 },
  ...
  { name:"Speechify",       icon:"🔈", cat:"voice",        desc:"Turn any text into audio — best AI text-to-speech app with 50M+ users",                   badge:"hot",  link:"https://speechify.com",                      rating:4.7 },
  ...
  { name:"TextCortex AI",   icon:"✍️", cat:"writing",      desc:"AI writing assistant — rewrite, summarize and generate content in 25+ languages",          badge:"free", link:"https://textcortex.com",                    rating:4.3 },
  ...
  { name:"GetResponse",     icon:"📧", cat:"productivity", desc:"AI email marketing and automation platform — create campaigns in minutes",                  badge:"paid", link:"https://www.getresponse.com",                rating:4.4 },
  ...
  { name:"HeadshotPro",     icon:"📸", cat:"avatar",       desc:"Turn your selfie into a professional LinkedIn headshot in 2 hours using AI",              badge:"paid", link:"https://www.headshotpro.com",                rating:4.5 },
